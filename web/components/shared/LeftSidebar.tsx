...
function LeftSidebar() {
  ...
  return (
    <section className="sticky left-0 top-0 z-20 flex h-screen w-fit flex-col justify-between overflow-auto border-r border-border bg-background pb-5 pt-28 max-md:hidden lg:w-[266px]">
